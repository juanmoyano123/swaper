...
**nunca se persiste ni se mezcla con nuestro dato**. Si mañana una de estas fuentes desaparece, lo
que se pierde es un bloque declarado vacío, no una columna del universo.
"""
