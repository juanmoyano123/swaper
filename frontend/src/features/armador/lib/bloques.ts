/**
 * Cómo se agrupa la cartera para leerla — Tanda 13.
 *
...
/** Qué clases de activo caen en qué bloque de renta fija. */
const BLOQUE_POR_CLASE_ACTIVO: Record<string, IdBloque> = {
