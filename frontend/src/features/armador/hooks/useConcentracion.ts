/**
 * Los topes de concentración de la cartera en construcción — F-020, sobre `POST /concentracion`.
 *
 ...
 * crédito, sector y ley está el peso— así que lo que la identifica es el peso que se manda. Firmar
 * con el monto haría refetch en cada refresh de mercado por un veredicto que no cambió.
 *
...
import { esquemaConcentracion, type NombreDePerfil } from '../lib/schemaConcentracion'
